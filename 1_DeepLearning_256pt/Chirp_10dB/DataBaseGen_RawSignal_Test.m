...
clear all, clc;
%---------------------- Nombre de Archivos --------------------------------
nom_dir = 'C:\Users\guill\OneDrive\Escritorio\ann_paper_hpo\1_DeepLearningExamples\Chirp_10dB\';
inputName     = 'Chirp_10dB_Test'; % .mat name
%--------------------------------------------------------------------------
cont = 1;
n_raw = 1000;
n_column = 256;
...
% individual files
nom_arch_SSC1 = 'Chirp_10dB_NoDef_raw_signal_Test'; 
nom_arch_SSC2 = 'Chirp_10dB_Gauss1_raw_signal_Test';
nom_arch_SSC3 = 'Chirp_10dB_Gauss2_raw_signal_Test';
nom_arch_SSC4 = 'Chirp_10dB_Pb1_raw_signal_Test';
nom_arch_SSC5 = 'Chirp_10dB_Pb2_raw_signal_Test';
...
TestMat_Chirp_10dB    = [Mat_database_SSC1;Mat_database_SSC2; ...
                 Mat_database_SSC3; Mat_database_SSC4; ...
                 Mat_database_SSC5];
save(inputName,'TestMat_Chirp_10dB'); % inputName
