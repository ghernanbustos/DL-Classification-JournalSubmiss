...
% matrix 1000x256 dimension. Be aware in case of changing data input size
%--------------------------------------------------------------------------
clear all, clc;
%---------------------- Nombre de Archivos --------------------------------
nom_dir = 'C:\Users\guill\OneDrive\Escritorio\ann_paper_hpo\1_DeepLearningExamples\Chirp_25dB\';
inputName     = 'Chirp_25dB_Train'; % .mat name
%--------------------------------------------------------------------------
cont = 1;
n_raw = 1000;
n_column = 256;
...
% individual files
nom_arch_SSC1 = 'Chirp_25dB_NoDef_raw_signal_Train'; 
nom_arch_SSC2 = 'Chirp_25dB_Gauss1_raw_signal_Train';
nom_arch_SSC3 = 'Chirp_25dB_Gauss2_raw_signal_Train';
nom_arch_SSC4 = 'Chirp_25dB_Pb1_raw_signal_Train';
nom_arch_SSC5 = 'Chirp_25dB_Pb2_raw_signal_Train';
...
TrainMat_Chirp_25dB    = [Mat_database_SSC1;Mat_database_SSC2; ...
                 Mat_database_SSC3; Mat_database_SSC4; ...
                 Mat_database_SSC5];
save(inputName,'TrainMat_Chirp_25dB'); % inputName
